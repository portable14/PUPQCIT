...
<body class="skin-josh">
  ...
  <aside class="right-side">
            <!-- Main content -->
            <!-- Main content -->
    <form role="form" id="loanform" method="POST" class="form-horizontal">            
	   <div class="row">
			<div class="col-lg-5">
                <div class="container">
                    <div class="col-md-4">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">                                   
                                    ...
                                    <!-- Date dd/mm/yyyy -->
										<div class="form-group">
											<label class="control-label col-md-3" for="Date Received">
												Date Received:
											</label>
											<div class="input-group">
												<div class="input-group-addon">
													...
													<input type="text" id="datereceived" name="datereceived" class="form-control" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required/>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <textarea rows="3" class="form-control" id="client" name="client" placeholder="Client Name" required></textarea>
                                                                </div>
                                                            </div>
															 <div class="form-group">
                                                                <label class="control-label col-md-3">Types of Loan:</label>
                                                                <div class="col-md-9">
                                                                    <select class="form-control" id="typesofloan" name="typesofloan" required>
                                                                        <option value="EL">EL</option>
																		<option value="Multi-Purpose Loan">Multi-Purpose Loan</option>
																		<option value="Educational Loan">Educational Loan</option>
																		<option value="Cellphone Loan">Cellphone Loan</option>
																		<option value="AsiaPro Calamity Loan">AsiaPro Calamity Loan</option>
																		...
																		<option value="Pag-ibig Multi-Purpose Loan">Pag-ibig Multi-Purpose Loan</option>
																		<option value="Motorcycle Loan">Motorcycle Loan</option>
																		<option value="Appliances Loan">Appliances Loan</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                    </div>
    ...
    $(document).ready(function()
    {
        $('#loanform').submit(function(e)
        {
            ...
            $.ajax
            ({
                url : "<?php echo base_url('addDMS/addLoan');?>",
                type : 'POST',
                data : formData,
                async : false,
                cache : false,
