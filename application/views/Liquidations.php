...
<head>
    <meta charset="UTF-8">
    <title>DMS | liquidations Form</title> 
  ...
  <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <!-- Main content -->
           <section class="content paddingleft_right15">
            ...
            <!-- Main content -->
            <!-- Main content --> 
            <form role="form" id="liquidationform" method="POST" class="form-horizontal">           
			<div class="row">
			<div class="col-lg-5">
                <div class="container">
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                        <input type="text" class="form-control" id="cvnumber" name="cvnumber" placeholder="" required></div>
                                    </div>
									<div class="form-group">
										<label class="control-label col-md-3" for="DM Date">
											DM Date:
										</label>
										<div class="input-group">
											<div class="input-group-addon">
												...
												<input type="text" class="form-control" id="dmdate" name="dmdate" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
                                        <label class="control-label col-md-3" for="particulars">Particulars:</label>
                                        <div class="col-md-9">
                                        <input type="text" class="form-control" id="particulars" name="particulars" placeholder="Particulars" required></div>
                                    </div>
									<div class="form-group">
										<label class="control-label col-md-3" for="Date Processed">
											Date Processed:
										</label>
										<div class="input-group">
											<div class="input-group-addon">
												...
												<input type="text" class="form-control" id="dateprocessed" name="dateprocessed" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required/>
										</div>
									</div>
							</div>
                            <div class="form-group">
    ...
    $(document).ready(function()
    {
        $('#liquidationform').submit(function(e)
        {
            ...
            var form_data = 
            {
                ...
                dateprocessed    : $('#dateprocessed').val(),
            }

             var   imgInp      = $('#imgInp').val();
             var cvnumber   = $('#cvnumber').val();
             var   dmdate  = $('#dmdate').val();
            ...
            var formData    = new FormData($('#liquidationform')[0]);

            e.preventDefault();
            $.ajax
            ({
                url : "<?php echo base_url('addDMS/addLiquidation');?>",
                type : 'POST',
                data : formData,
                async : false,
                cache : false,
