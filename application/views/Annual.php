  ...
  <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <!-- Main content -->
           <section class="content paddingleft_right15">
            ...
            <!-- Main content -->
            <!-- Main content --> 
            <form role="form" id="annualform" method="POST" class="form-horizontal">           
			<div class="row">
			<div class="col-lg-5">
                <div class="container">
                    <div class="col-md-4">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
									...
									<div class="form-group">
										<label class="control-label col-md-3" for="Date of PE">
											Date of PE:
										</label>
										<div class="input-group">
											<div class="input-group-addon">
												...
												<input type="text" class="form-control" id="datepe" name="datepe" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
                                        <label class="control-label col-md-3" for="findings">Findings:</label>
                                        <div class="col-md-9">
                                            <textarea rows="3" class="form-control" id="findings" name="findings" placeholder="Findings" required></textarea>
                                        </div>
                                    </div>
							</div>
                            <div class="form-group">
    ...
    $(document).ready(function()
    {
        $('#annualform').submit(function(e)
        {
            ...
            var form_data = 
            {
             ...
             var   datepe      = $('#datepe').val();
             var   laboratory   = $('#laboratory').val();
             var   findings    = $('#findings').val();
            var formData    = new FormData($('#annualform')[0]);

            e.preventDefault();
            $.ajax
            ({
                url : "<?php echo base_url('addDMS/addAnnual');?>",
                type : 'POST',
                data : formData,
                async : false,
                cache : false,
