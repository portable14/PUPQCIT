  ...
  <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <!-- Main content -->
           <section class="content paddingleft_right15">
            ...
            <!-- Main content -->
            <!-- Main content --> 
            <form role="form" id="benefitform" method="POST" class="form-horizontal">           
            <div class="row">
            <div class="col-lg-5">
                <div class="container">
                    <div class="col-md-4">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label col-md-3" for="firstName">ID Number:</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3" for="sssNumber">SSS #:</label>
                            <div class="col-md-9">
                            <input type="text" class="form-control" id="sssnumber" name="sssnumber" placeholder="SSS Number" required></div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3" for="sssNumber">Remarks:</label>
                            <div class="col-md-9">
                            <textarea rows="3" class="form-control" id="remarks" name="remarks" placeholder="Course" required></textarea>
                            </div>
                        </div>
                </div>
                <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label col-md-3" for="philhealthNumber">PhilHealth #:</label>
                                <div class="col-md-9">
                                <input type="text" class="form-control" id="philhealthnumber" name="philhealthnumber" placeholder="PhilHealth Number" required></div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3" for="pagibigNumber">Pagibig #:</label>
                            <div class="col-md-9">
                            <input type="text" class="form-control" id="pagibignumber" name="pagibignumber" placeholder="Pagibig Number" required></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="datereceived" name="datereceived" class="form-control" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Claim Type:</label>
                                <div class="col-md-9">
                                    <select class="form-control" id="claimtype" name="claimtype">
                                        <option value="Maternity">Maternity</option>
                                        <option value="Asia-Pro Sickness">Asia-Pro Sickness</option>
                                        <option value="Asia-Pro Accident">Asia-Pro Accident</option>
                                        <option value="SSS-Sickness">SSS-Sickness</option>
                                        <option value="Paternity">Paternity</option>
                                        <option value="Solo Parent">Solo Parent</option>
                                        <option value="HMO">HMO</option>
                                        <option value="EC Sickness">EC Sickness</option>
                                        <option value="VAWC">VAWC</option>
                                        <option value="Magna Carta">Magna Carta</option>
                                        <option value="sia-Pro MIL">Asia-Pro MIL</option>
                                    </select>
                                </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Death Claim:</label>
                            <div class="col-md-9">
                                <select class="form-control" id="deathclaim" name="deathclaim">
    ...
    $(document).ready(function()
    {
        $('#benefitform').submit(function(e)
        {
            ...
            var form_data = 
            {
             ...
             var   philhealthnumber    = $('#philhealthnumber').val();
             var   pagibignumber    = $('#pagibignumber').val();
             var   datereceived    = $('#datereceived').val();
             var   claimtype    = $('#claimtype').val();
             var   deathclaim    = $('#deathclaim').val();
            var formData    = new FormData($('#benefitform')[0]);

            e.preventDefault();
            $.ajax
            ({
                url : "<?php echo base_url('addDMS/addBenefit');?>",
                type : 'POST',
                data : formData,
                async : false,
                cache : false,
