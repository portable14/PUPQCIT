											...
											<div class="row">
												<div class="col-lg-12">																										
													<div class="panel-body">
														...
														<div class="form-group">                                        
															<label class="checkbox-inline">
																<input type="checkbox" value="Add User">Add User</label>
															<label class="checkbox-inline">
																<input type="checkbox" value="Delete User">Delete User</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <form class="form-wizard" action="#" method="POST">
                                            <h1 class="hidden-xs">Employee's Profile</h1>
											<section>
                                                <h2 class="hidden">&nbsp;</h2>
												<div class="form-group">
													<div class="col-lg-3">
														<div class="fileinput fileinput-new" data-provides="fileinput">
															...
															<div>
																<span class="btn btn-default btn-file">
																	...
																	<input type="file" name="..." class="form-control required"></span>
                                            ...
                                            <h1 class="hidden-xs">Employee's Profile Details</h1>
											<section>
                                            ...
                                            <h1>Employee's Access Rights</h1>
                                            ...
                                            <section>												
												...
												<div class="col-lg-12">																										
													<div class="panel-body">
														<div class="form-group">                                        
															<label class="checkbox-inline">
																<input type="checkbox">Print/Export</label>
															<label class="checkbox-inline">
																<input type="checkbox">Scan/Import</label>
															<label class="checkbox-inline">
																<input type="checkbox">Delete</label>
														</div>														
													</div>
												</div>
											</div>                                                         
