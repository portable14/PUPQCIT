...
<head>
    <meta charset="UTF-8">
    <title>DMS | Clearance/Waiver Form</title> 
...
<body class="skin-josh">
  ...
  <aside class="right-side">
            <!-- Main content -->
            <!-- Main content --> 
            <form role="form" id="clearanceform" method="POST" class="form-horizontal">           
			<div class="row">
			<div class="col-lg-5">
                <div class="container">
                    <div class="col-md-4">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">									
									...
									<div class="form-group">
										...
										<div class="input-group">
											<div class="input-group-addon">
												...
												<input type="text" id="lastwork" name="lastwork" class="form-control" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label class="control-label col-md-3" for="Date Received from Member:">
										...
										<div class="input-group">
											<div class="input-group-addon">
												...
												<input type="text" class="form-control" id="datemember" name="datemember" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required/>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3" for="Date Received from MBS">
											Date Received from MBS:
										</label>
										<div class="input-group">
											<div class="input-group-addon">
												<i class="fa fa-calendar"></i>
											</div>
												<input type="text" class="form-control" id="datembs" name="datembs" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required/>
										</div>
									</div>									
									<div class="form-group">
										<label class="control-label col-md-3" for="Date Received from Finance">
											Date Processed from Finance:
										</label>
										<div class="input-group">
											<div class="input-group-addon">
												<i class="fa fa-calendar"></i>
											</div>
												<input type="text" class="form-control" id="datefinance" name="datefinance" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required/>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3" for="Date Transmitted to Head Office	">
											Date Transmitted to Head Office:
										</label>
										<div class="input-group">
											<div class="input-group-addon">
												<i class="fa fa-calendar"></i>
											</div>
												<input type="text" class="form-control" id="dateheadoffice" name="dateheadoffice" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required/>
										</div>
									</div>
									<div class="form-group">
                                        <label class="control-label col-md-3" for="otherdeductions">Other Deductions:</label>
                                        <div class="col-md-9">
                                        <input type="text" class="form-control" id="otherdeductions" name="otherdeductions" placeholder="Other Deductions" required></div>
                                    </div>
							</div>
                            <div class="form-group">
    ...
    $(document).ready(function()
    {
        $('#clearanceform').submit(function(e)
        {
            ...
            var form_data = 
            {
                ...
                datemember    : $('#datemember').val(),
                datembs    : $('#datembs').val(),
                datefinance    : $('#datefinance').val(),
                dateheadoffice    : $('#dateheadoffice').val(),
            ...
            var    datemember    = $('#datemember').val();
            var    datembs    = $('#datembs').val();
            var    datefinance    = $('#datefinance').val();
            var    dateheadoffice    = $('#dateheadoffice').val();
            var    otherdeductions    = $('#otherdeductions').val();
            var formData    = new FormData($('#clearanceform')[0]);

            e.preventDefault();
            $.ajax
            ({
                url : "<?php echo base_url('addDMS/addClearance');?>",
                type : 'POST',
                data : formData,
                async : false,
                cache : false,
