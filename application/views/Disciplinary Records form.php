  ...
  <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <!-- Main content -->
           <section class="content paddingleft_right15">
            ...
            <!-- Main content -->
            <!-- Main content --> 
            <form role="form" id="disciplinaryform" method="POST" class="form-horizontal">           
            <div class="row">
            <div class="col-lg-5">
                <div class="container">
                    <div class="col-md-4">
        ...
        <div class="col-md-12"> 
            ...
            <div class="form-group">
                ...
                <input type="text" maxlength="30" name="idnumber" class="form-control" id="idnumber" placeholder="ID number" required="" />
            </div>
            <div class="form-group">
                <label for="default" class="control-label">
                First Name
                </label>
                <input type="text" maxlength="30" name="firstname" class="form-control" id="firstname" placeholder="First Name" required />
            </div>
            <div class="form-group">
                <label for="default" class="control-label">Middle Name</label>
                <input type="text" class="form-control" maxlength="30" name="middlename" id="middlename" placeholder="Middle Name" required/>
            </div>
            <div class="form-group">
                <label for="default" class="control-label">
                Last Name
                </label>
                <input type="text" class="form-control" maxlength="30" name="lastname" id="lastname" placeholder="Last Name" required />
            </div>
            <div class="form-group">
                <label for="default" class="control-label">
                Client Assigned
                </label>
                <select class="form-control" name="clientassigned" id="clientassigned" required>
            ...
            <div class="form-group">
                ...
                Violation
                    ...
                    <select class="form-control" name="violation" id="violation">
                        ...
                        <option value="Not Following Order">Not Following Order</option>
    ...
    {
        $('#disciplinaryform').submit(function(e)
        {
            ...
            var formData    = new FormData($('#disciplinaryform')[0]);

            e.preventDefault();
            $.ajax
            ({
                url : "<?php echo base_url('addDMS/addDisciplinary');?>",
                type : 'POST',
                data : formData,
                async : false,
                cache : false,
